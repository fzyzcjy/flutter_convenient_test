...
generate-gif:
    ffmpeg -y -i doc/videos/a_action_history.mov doc/gif/a_action_history.gif
    ffmpeg -y -i doc/videos/b_time_travel_screenshot.mov doc/gif/b_time_travel_screenshot.gif
    ffmpeg -y -i doc/videos/c_rapid_execute.mov doc/gif/c_rapid_execute.gif
    ffmpeg -y -i doc/videos/d_video_record.mov doc/gif/d_video_record.gif
    ffmpeg -y -i doc/videos/e_interactive.mov doc/gif/e_interactive.gif
