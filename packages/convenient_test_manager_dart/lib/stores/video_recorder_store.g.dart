...
mixin _$VideoRecorderStore on _VideoRecorderStore, Store {
  late final _$recordingVideoInfoAtom = Atom(name: '_VideoRecorderStore.recordingVideoInfo', context: context);
  ...
  late final _$startRecordAsyncAction = AsyncAction('_VideoRecorderStore.startRecord', context: context);
  ...
  late final _$stopRecordAsyncAction = AsyncAction('_VideoRecorderStore.stopRecord', context: context);
