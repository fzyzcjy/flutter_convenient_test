...
mixin _$GoldenDiffPageStore on _GoldenDiffPageStore, Store {
  late final _$gitFolderInfoAtom = Atom(name: '_GoldenDiffPageStore.gitFolderInfo', context: context);
  ...
  late final _$highlightPathAtom = Atom(name: '_GoldenDiffPageStore.highlightPath', context: context);
  ...
  late final _$highlightTransformAtom = Atom(name: '_GoldenDiffPageStore.highlightTransform', context: context);
