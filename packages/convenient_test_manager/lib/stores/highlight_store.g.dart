...
mixin _$HighlightStore on _HighlightStore, Store {
  late final _$enableAutoExpandAtom = Atom(
    name: '_HighlightStore.enableAutoExpand',
    context: context,
  );
  ...
  late final _$enableAutoJumpAtom = Atom(
    name: '_HighlightStore.enableAutoJump',
    context: context,
  );
  ...
  late final _$enableHoverModeAtom = Atom(
    name: '_HighlightStore.enableHoverMode',
    context: context,
  );
  ...
  late final _$highlightTestEntryIdAtom = Atom(
    name: '_HighlightStore.highlightTestEntryId',
    context: context,
  );
  ...
  set highlightTestEntryId(int? value) {
    _$highlightTestEntryIdAtom.reportWrite(
      value,
      super.highlightTestEntryId,
      () {
  ...
  late final _$highlightLogEntryIdAtom = Atom(
    name: '_HighlightStore.highlightLogEntryId',
    context: context,
  );
  ...
  late final _$highlightSnapshotAtom = Atom(
    name: '_HighlightStore.highlightSnapshot',
    context: context,
  );

  @override
  LogEntryAndSnapshot? get highlightSnapshot {
    _$highlightSnapshotAtom.reportRead();
    return super.highlightSnapshot;
  }

  @override
  set highlightSnapshot(LogEntryAndSnapshot? value) {
    _$highlightSnapshotAtom.reportWrite(value, super.highlightSnapshot, () {
      super.highlightSnapshot = value;
    });
  }

  late final _$_HighlightStoreActionController = ActionController(
    name: '_HighlightStore',
    context: context,
  );
