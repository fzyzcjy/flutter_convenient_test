...
mixin _$HomePageStore on _HomePageStore, Store {
  late final _$displayLoadedReportModeAtom = Atom(
    name: '_HomePageStore.displayLoadedReportMode',
    context: context,
  );
  ...
  set displayLoadedReportMode(bool value) {
    _$displayLoadedReportModeAtom.reportWrite(
      value,
      super.displayLoadedReportMode,
      () {
  ...
  late final _$activeSecondaryPanelTabAtom = Atom(
    name: '_HomePageStore.activeSecondaryPanelTab',
    context: context,
  );
  ...
  set activeSecondaryPanelTab(HomePageSecondaryPanelTab value) {
    _$activeSecondaryPanelTabAtom.reportWrite(
      value,
      super.activeSecondaryPanelTab,
      () {
  ...
  late final _$expandSecondaryPanelAtom = Atom(
    name: '_HomePageStore.expandSecondaryPanel',
    context: context,
  );
  ...
  set expandSecondaryPanel(bool value) {
    _$expandSecondaryPanelAtom.reportWrite(
      value,
      super.expandSecondaryPanel,
      () {
