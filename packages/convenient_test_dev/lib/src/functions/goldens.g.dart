...
_$GoldenConfigPrimary _$$GoldenConfigPrimaryFromJson(Map<String, dynamic> json) => _$GoldenConfigPrimary(
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$$GoldenConfigPrimaryToJson(_$GoldenConfigPrimary instance) => <String, dynamic>{
      'runtimeType': instance.$type,
    };

_$GoldenConfigSecondary _$$GoldenConfigSecondaryFromJson(Map<String, dynamic> json) => _$GoldenConfigSecondary(
...
Map<String, dynamic> _$$GoldenConfigSecondaryToJson(_$GoldenConfigSecondary instance) => <String, dynamic>{
