...
class SuiteInfo {
  ...
  const SuiteInfo._({required this.rootGroupId, required this.entryMap, required this.entryIdOfName});
  ...
  factory SuiteInfo.fromProto(SuiteInfoProto proto) {
    ...
    return SuiteInfo._(rootGroupId: proto.groupId.toInt(), entryMap: entryMap, entryIdOfName: entryIdOfName);
  }
...
abstract class GroupEntryInfo {
  ...
  const GroupEntryInfo({required this.parentId, required this.id, required this.name});
...
class GroupInfo extends GroupEntryInfo {
  ...
  const GroupInfo({required super.id, required super.name, required super.parentId, required this.entryIds});
...
class TestInfo extends GroupEntryInfo {
  const TestInfo({required super.id, required super.name, required super.parentId});

  factory TestInfo.fromProto(TestInfoProto proto) =>
      TestInfo(id: proto.id.toInt(), name: proto.name, parentId: proto.parentId.toInt());
