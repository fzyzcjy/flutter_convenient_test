...
const LogEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'test_id', '3': 2, '4': 1, '5': 3, '10': 'testId'},
...
final $typed_data.Uint8List logEntryDescriptor = $convert.base64Decode(
    'CghMb2dFbnRyeRIOCgJpZBgBIAEoA1ICaWQSFwoHdGVzdF9pZBgCIAEoA1IGdGVzdElkEi0KC3N1Yl9lbnRyaWVzGAMgAygLMgwuTG9nU3ViRW50cnlSCnN1YkVudHJpZXM=');
...
const RunnerStateChange$json = const {
  '1': 'RunnerStateChange',
  '2': const [
    const {'1': 'test_id', '3': 1, '4': 1, '5': 3, '10': 'testId'},
...
final $typed_data.Uint8List runnerStateChangeDescriptor = $convert.base64Decode(
    'ChFSdW5uZXJTdGF0ZUNoYW5nZRIXCgd0ZXN0X2lkGAEgASgDUgZ0ZXN0SWQSJQoFc3RhdGUYAiABKAsyDy5UZXN0RW50cnlTdGF0ZVIFc3RhdGU=');
...
final $typed_data.Uint8List runnerErrorDescriptor = $convert.base64Decode(
    'CgtSdW5uZXJFcnJvchIXCgd0ZXN0X2lkGAEgASgDUgZ0ZXN0SWQSFAoFZXJyb3IYAiABKAlSBWVycm9yEh8KC3N0YWNrX3RyYWNlGAMgASgJUgpzdGFja1RyYWNl');
...
final $typed_data.Uint8List runnerMessageDescriptor =
    $convert.base64Decode('Cg1SdW5uZXJNZXNzYWdlEhcKB3Rlc3RfaWQYASABKANSBnRlc3RJZBIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdl');
