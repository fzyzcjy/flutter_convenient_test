...
final $typed_data.Uint8List logSubEntryTypeDescriptor = $convert.base64Decode(
    'Cg9Mb2dTdWJFbnRyeVR5cGUSCwoHSU5WQUxJRBAAEhMKD0dFTkVSQUxfTUVTU0FHRRABEg4KCl'
...
final $typed_data.Uint8List reportItemDescriptor = $convert.base64Decode(
    'CgpSZXBvcnRJdGVtEikKCnNldF91cF9hbGwYByABKAsyCS5TZXRVcEFsbEgAUghzZXRVcEFsbB'
...
final $typed_data.Uint8List tearDownAllDescriptor = $convert.base64Decode(
    'CgtUZWFyRG93bkFsbBJZChlyZXNvbHZlZF9leGVjdXRpb25fZmlsdGVyGAEgASgLMh0uUmVzb2'
...
final $typed_data.Uint8List logEntryDescriptor = $convert.base64Decode(
    'CghMb2dFbnRyeRIOCgJpZBgBIAEoA1ICaWQSGwoJdGVzdF9uYW1lGAIgASgJUgh0ZXN0TmFtZR'
...
final $typed_data.Uint8List logSubEntryDescriptor = $convert.base64Decode(
    'CgtMb2dTdWJFbnRyeRIOCgJpZBgBIAEoA1ICaWQSEgoEdGltZRgCIAEoA1IEdGltZRIkCgR0eX'
...
final $typed_data.Uint8List suiteInfoProtoDescriptor = $convert.base64Decode(
    'Cg5TdWl0ZUluZm9Qcm90bxIZCghncm91cF9pZBgBIAEoA1IHZ3JvdXBJZBInCgZncm91cHMYAi'
...
final $typed_data.Uint8List groupInfoProtoDescriptor = $convert.base64Decode(
    'Cg5Hcm91cEluZm9Qcm90bxIOCgJpZBgBIAEoA1ICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRIbCg'
...
final $typed_data.Uint8List testInfoProtoDescriptor = $convert.base64Decode(
    'Cg1UZXN0SW5mb1Byb3RvEg4KAmlkGAEgASgDUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhsKCX'
...
final $typed_data.Uint8List runnerStateChangeDescriptor = $convert.base64Decode(
    'ChFSdW5uZXJTdGF0ZUNoYW5nZRIbCgl0ZXN0X25hbWUYASABKAlSCHRlc3ROYW1lEiUKBXN0YX'
...
final $typed_data.Uint8List testEntryStateDescriptor = $convert.base64Decode(
    'Cg5UZXN0RW50cnlTdGF0ZRIWCgZzdGF0dXMYASABKAlSBnN0YXR1cxIWCgZyZXN1bHQYAiABKA'
    'lSBnJlc3VsdA==');
...
final $typed_data.Uint8List runnerErrorDescriptor = $convert.base64Decode(
    'CgtSdW5uZXJFcnJvchIbCgl0ZXN0X25hbWUYASABKAlSCHRlc3ROYW1lEhQKBWVycm9yGAIgAS'
...
final $typed_data.Uint8List runnerMessageDescriptor = $convert.base64Decode(
    'Cg1SdW5uZXJNZXNzYWdlEhsKCXRlc3RfbmFtZRgBIAEoCVIIdGVzdE5hbWUSGAoHbWVzc2FnZR'
...
final $typed_data.Uint8List snapshotDescriptor = $convert.base64Decode(
    'CghTbmFwc2hvdBIgCgxsb2dfZW50cnlfaWQYASABKANSCmxvZ0VudHJ5SWQSEgoEbmFtZRgCIA'
...
final $typed_data.Uint8List workerCurrentRunConfigDescriptor = $convert.base64Decode(
    'ChZXb3JrZXJDdXJyZW50UnVuQ29uZmlnElEKD2ludGVyYWN0aXZlX2FwcBgBIAEoCzImLldvcm'
...
final $typed_data.Uint8List executionFilterDescriptor = $convert.base64Decode(
    'Cg9FeGVjdXRpb25GaWx0ZXISKgoRZmlsdGVyX25hbWVfcmVnZXgYASABKAlSD2ZpbHRlck5hbW'
...
final $typed_data.Uint8List resolvedExecutionFilterProtoDescriptor =
    $convert.base64Decode(
        'ChxSZXNvbHZlZEV4ZWN1dGlvbkZpbHRlclByb3RvEjcKGGFsbG93X2V4ZWN1dGVfdGVzdF9uYW'
